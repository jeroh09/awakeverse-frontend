// components/CharacterStatusModal.jsx - Handles pending, rejected, and upgrade flows
import React, { useState } from 'react';

const CharacterStatusModal = ({ character, onClose, onCreateNew, onUpgrade }) => {
  ...
  const handlePrimaryAction = () => {
    if (character.status === 'pending') {
      // Show upgrade flow for priority approval
      onUpgrade();
